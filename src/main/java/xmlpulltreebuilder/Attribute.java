 ...
 * </p>
 * <p>
 * According to the XmlPullParser documentation, if the parser is non-validating the type is always CDATA. At the time of this writing there were no validating
 * XmlPullParsers, so the type field will always be CDATA, making this field rather useless.
 * </p>
 * 
 * @author Ian Kaplan, www.bearcave.com, iank@bearcave.com
 */
public class Attribute extends NamedEntity {
	...
	public void setAttrType(String ty) {
		mType = ty;
	}
	...
	public Attribute getNext() {
		return (Attribute) this.getSibling();
	}

	public void setNext(Attribute attr) {
		this.setSibling(attr);
	}
