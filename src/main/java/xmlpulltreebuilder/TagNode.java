 ...
 * </p>
 */
public class TagNode extends NamedEntity implements Iterable<TagNode> {
	...
	public void setAttrList(AttributeList attrList) {
	...
	public boolean hasAttr(String name) {
		...
		if (mAttrList != null) {
			for (Attribute attribute : mAttrList) {
	...
	@Override
	public Iterator<TagNode> iterator() {

		return childrenTagNodeIterator();
	}
