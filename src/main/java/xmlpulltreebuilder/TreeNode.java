...
public abstract class TreeNode {
	...
	public class ChildrenIterator implements Iterator<TagNode> {
		...
		public TagNode next() {
			...
			while (curr != null && !(curr instanceof TagNode));
			return (TagNode) toRet;
		}
	...
	public Iterator<TagNode> childrenTagNodeIterator() {
